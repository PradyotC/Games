...
public class playermovement_level_fast : MonoBehaviour
{
    ...
    private float increased_speed_of_player = 15f;
    ...
    void Update()
    {
      ...
      if ((int)transform.position.x == 25 && dash_tutorial)
      {
        ...
        dash_cube=GameObject.CreatePrimitive(PrimitiveType.Cube);
          ...
          TextDisplay.text = "Fast enables Ninja to collect double the points for correct Rhythm, Press Enter to continue";
          ...
          dash_cube.transform.position = new Vector3(transform.position.x+7, transform.position.y+4, transform.position.z-2);
      ...
      if ((int)transform.position.x == 40 && dash_tutorial_launch)
      {
        ...
        dash_cube_launch=GameObject.CreatePrimitive(PrimitiveType.Cube);
          ...
          TextDisplay.text = "Press N to use Speed up";
          TextDisplay.fontSize = 8;
          TextDisplay.color = new Color32(255, 128, 0, 255);
          RectTransform placement = dash_cube_launch.GetComponent<RectTransform>();
          dash_cube_launch.transform.position = new Vector3(transform.position.x+7, transform.position.y+3, transform.position.z-2);
      ...
      if(Gravity_level_dash.reverseGravity){
      ...
      /// Dashing -> increases the speed
       ...
       if (Input.GetKeyDown(KeyCode.N) && Fast_level_dash.fast){
      ...
      if ((int)transform.position.x == 120){
