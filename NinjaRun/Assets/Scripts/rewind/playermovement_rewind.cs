...
public class playermovement_rewind : MonoBehaviour
{
    ...
    void Update()
    {
      if(Gravity_rewind.reverseGravity){
      ...
      if (Reverse_Functionality_rewind.reverseFunctionality) {
        StartCoroutine(ReverseFunctions(original_speed_of_player, reverseFunctionTime));
      }

      if ((int)transform.position.x == 70){
      ...
      if (myCharacterController.isGrounded && jumpUp && Reverse_Functionality_rewind.reverseFunctionality == false && moveVector.z == 0) {
      ...
      else if (jumpUp && transform.position.y<4 && (moveVector.y > 0f || moveVector.y < 0f) && Reverse_Functionality_rewind.reverseFunctionality == false && double_jump_active==1) {
        // UnityEngine.Debug.Log("Double Jump");
        moveVector.y = jumpSpeed+1.25f;
        double_jump_active = 0;
      }
      if (Input.GetKeyDown(KeyCode.LeftShift ) && Reverse_Functionality_rewind.reverseFunctionality == false) {
        ducktime = 180;
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////////////////
      ////////////////////////////////////////////////////////////////////////////////////////////////////////
      /////////////////////////////////////Rewind Tutorial code below/////////////////////////////////////////
      ///////////////////////////////////////////////////////////////////////////////////////////////////////
      ///////////////////////////////////////////////////////////////////////////////////////////////////////
      
      if (Reverse_rewind.reverse && Input.GetKeyDown(KeyCode.N)) {      
        StartCoroutine(ReverseSpeed(reverse_speed_of_player,original_speed_of_player,reverseSpeedTime));
      }

      if(Reverse_rewind.test && GameObject.Find("Reverse_Test").transform.position.x - GameObject.Find("Ch24_nonPBR@Running").transform.position.x <= 3){
          SongController_rewind.test = true;
          Time.timeScale = 0f;
          GameObject cube1 = GameObject.CreatePrimitive(PrimitiveType.Cube);
          cube1.name = "cube1";
          cube1.transform.position = new Vector3(transform.position.x+10, transform.position.y+3, transform.position.z);
          cube1.AddComponent<TextMeshPro>();
          TextMeshPro TextDisplay = cube1.GetComponent<TextMeshPro>();
          TextDisplay.color = new Color32(255, 188, 0, 255);
          TextDisplay.text = "Use rewind by pressing N\nIt helps you collect the numbers you missed\nPress Enter to continue";
          TextDisplay.fontSize = 8;
          Reverse_rewind.test = false;
      }

      if(Time.timeScale == 0f && !Reverse_rewind.test && Input.GetKeyDown(KeyCode.Return)){
        GameObject.Find("cube1").SetActive(false);
        Time.timeScale = 1f;
        SongController_rewind.test = false;
      }
    ...
    private IEnumerator ReduceSpeed(float new_speed, float original_speed, float time) {
      ...
      yield return new WaitForSeconds(time);
      // UnityEngine.Debug.Log("Normal Speed Again");
      Slow_rewind.slow = false;
      speed = original_speed;
      audioData.pitch = 1;
      isSlow = false;
    ...
    private IEnumerator ReverseFunctions(float original_speed, float time) {
      ...
      Reverse_Functionality_rewind.reverseFunctionality = true;
      speed = original_speed;
      ...
      // UnityEngine.Debug.Log("Reverse Functionality activated");
      speed = original_speed;
      ...
      // UnityEngine.Debug.Log("Reverse Functionality Over");
      // tr.emitting = false;
      Reverse_Functionality_rewind.reverseFunctionality = false;
      speed = original_speed;
      // speed = original_speed;
      // audioData.pitch = 1;
    }
...
public IEnumerator ReverseGravity(float time) {
      ...
      Gravity_rewind.reverseGravity = false;
    }
