...
public class GenerateNodes_platform_level : MonoBehaviour
{
    ...
    void Start()
    {
        for (int i = 0; i < myNum.Length; i++)
        {
            ...
            if (random == 1){
                cube.AddComponent<DScript_platform_level>();
                ...
                cube.AddComponent<SScript_platform_level>();
                cube.AddComponent<TextMeshPro>();
                TextMeshPro TextDisplay = cube.GetComponent<TextMeshPro>();
                TextDisplay.text = "W";
                TextDisplay.fontSize = 10;
                ...
                cube.AddComponent<AScript_platform_level>();
                cube.AddComponent<TextMeshPro>();
                TextMeshPro TextDisplay = cube.GetComponent<TextMeshPro>();
                TextDisplay.text = "Q";
                TextDisplay.fontSize = 10;
