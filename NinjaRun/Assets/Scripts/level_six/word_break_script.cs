...
public class word_break_script : MonoBehaviour
{
...
private void OnTriggerEnter(Collider other){
        if (other.name=="Ch24_nonPBR@Running") {
            ...
            GenerateNodes_platform_level_six.all_letter_word.Add(gameObject.GetComponent<TextMeshPro> ().text);
            Destroy(gameObject);
            if (GenerateNodes_platform_level_six.all_letter_word.Count==5){
                ...
                // text_message.AddComponent<word_break_script>();
                ...
                // Debug.Log(GenerateNodes_platform_level_six.all_letter_word);
...
//For False wall with bonus points
                ...
                false_cube.AddComponent<false_wall_script>();
...
////////////////////////////////////////////////////////////////
        ...
        Debug.Log(GenerateNodes_platform_level_six.all_letter_word.Count);
        }
        // else{
