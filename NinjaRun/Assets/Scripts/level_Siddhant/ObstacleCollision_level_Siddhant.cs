...
public class ObstacleCollision_level_Siddhant : MonoBehaviour
{
    ...
    {
        if (!Reverse_level_Siddhant.reverse && collision.name == "Ch24_nonPBR@Running" && !Dash_level_Siddhant.dash)
        {
